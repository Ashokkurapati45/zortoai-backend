...
class Order(models.Model):
    ...
    risk_band = models.CharField(max_length=20, blank=True,null=True)  # LOW / MEDIUM / HIGH
    risk_reasons = models.TextField(blank=True, null=True)      # store as text (comma-separated or JSON)
